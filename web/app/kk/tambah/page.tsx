  ...
  return (
    <div className="flex min-h-screen w-full flex-col p-4 md:p-8">
      <div className="mx-auto w-full max-w-3xl space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Buat data master KK baru sebelum menambahkan anggota keluarga.
            </p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Formulir Kartu Keluarga (KK)</CardTitle>
            <CardDescription>Nomor KK dan Alamat domisili wajib diisi dengan benar.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex justify-end pt-4">
                <Button type="submit" disabled={isLoading} className="gap-2">
                  ...
                  {isLoading ? "Menyimpan..." : "Buat Kartu Keluarga"}
                </Button>
              </div>
