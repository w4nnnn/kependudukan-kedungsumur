...
export default function TambahPendudukPage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      kkRt: "",
      kkRw: "",
      kkDusun: "Dusun Krajan",
      kkKodePos: "65171",
      kkTanggalDikeluarkan: undefined,
    },
  })
                      ...
                      <div className="flex flex-col space-y-1.5 md:col-span-2">
                        ...
                        <Popover>
                          <PopoverTrigger className={cn(
                            ...
                            {watch("kkTanggalDikeluarkan") ? formatDateId(watch("kkTanggalDikeluarkan") as Date) : <span>Pilih tanggal terbit KK</span>}
                          </PopoverTrigger>
